...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_56361c06f053b6_93263631',
  'file_dependency' => 
  array (
...
if ($_valid && !is_callable('content_56361c06f053b6_93263631')) {
function content_56361c06f053b6_93263631 ($_smarty_tpl) {
?>
<!doctype html>
<html class="no-js">
<head>
        ...
        <form class="am-form">
          <div class="am-g am-margin-top am-form-group">
            ...
            <div class="am-u-sm-8 am-u-md-4 am-u-end">
              <input type="text" class="am-input-sm"  name="title" data-validation-message="文章标题必填" placeholder="输入文章标题" value="" required>
            </div>
          </div>
          ...
          <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
              <input type="text" class="am-input-sm" value="admin" readonly>
            </div>
          </div>
          ...
          <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-8 am-u-md-4">
              <input type="text" class="am-input-sm" name="desc" value="">
            </div>
          ...
          <div class="am-g am-margin-top-sm">
            ...
            <div class="am-u-sm-16 am-u-md-6 am-u-end">
              <textarea rows="16" name="content"></textarea>
            </div>
          </div>
...
<script src="http://ci.me.com/style/picker/kindeditor/kindeditor-min.js"></script>
<script src="http://ci.me.com/style/picker/kindeditor/lang/zh_CN.js"></script>
<script>
  var editor;
